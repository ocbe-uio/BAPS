...
BAPSFOLDERS = ./admixture/* ./general/* ./graph/* ./independent/* ./linkage/* ./parallel/* ./spatial/* ./greedyMix/*
...
BAPS_package/run_baps6.sh: $(BAPSFOLDERS)
	...
	@$(MATLABEXEC) $(MATLABOPTS) "run('general/add_BAPS_to_path.m'); exit;"
	@echo "done"
